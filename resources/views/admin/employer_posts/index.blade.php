        ...
        <div class="col-md-12 mt-4">
            <div class="card">
                <div class="card-header">
                    <h6 class="card-title mb-0">Employer Posts</h6>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($blogs as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.employer-posts.edit', $item->id) }}" type="button"
                                        ...
                                        <a href="{{ route('admin.employer-posts.destroy', $item->id) }}" type="button"
                                        ...
                                        <form action="{{ route('admin.employer-posts.destroy', $item->id) }}" method="post"
