            ...
            <div class="row g-0 justify-content-center">
                <div class="col-xl-4 col-lg-5 col-md-7 col-sm-8">
                    ...
                    <h3 style="text-align: center;"><strong><img
                                ...
                                src="https://nhiregroup.com/assets/front/new/images/NhireLogo.jpg" alt=""
                                width="200" /><span style="color: #008000;">Fill Your Application
                                Form</span></strong></h3>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text" name="epin" class="form-control @error('epin') is-invalid @enderror"
                                placeholder="Jobpass" value="{{ old('epin') }}" required>
                            <label>Jobpass</label>
                            @error('epin')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <p><a href="/agents" target="_blank" style="color: blue; font-weight: 700; font-size: 16px;"><u>Don't
                                have a pass, click here to
                                buy.</u></a></p>
                    @if ($referral)
                        <div class="col-12">
                            <div class="form-floating">
                    ...
                    <div class="col-12 text-center mt-4">
                        <span class="text-muted">Are you an employee? Login to office <a
                                href="{{ route('user.login') }}">Apply Here</a></span>
                    </div>
                    {{-- </form> --}}
                    <!-- End Form -->
                </div>
